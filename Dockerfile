...
ENV KC_DB=mysql
#ENV KC_DB_URL=jdbc:mysql://92.4.91.87:3306/keycloack_elva_db?useSSL=false&allowPublicKeyRetrieval=true
ENV KC_DB_URL_HOST=92.4.91.87
ENV KC_DB_URL_PORT=3306
ENV KC_DB_URL_DATABASE=keycloack_elva_db
